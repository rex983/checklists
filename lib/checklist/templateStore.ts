...
export function getDefaultTemplateBlocks(): EditableTemplateBlock[] {
  return [
    ...
    },
    {
      ...
      title: 'Land Prep — Asphalt',
      icon: '🏗',
      timelineLabel: 'Weeks 2–4',
      action: 'Make sure your asphalt pad is level and meets county requirements.',
      bullets: [
        { id: bulletId(), text: 'Your building will be installed on an asphalt pad — the surface must be level within 3" across the footprint.', locked: false },
        { id: bulletId(), text: 'Confirm any local county requirements for the foundation.', locked: false },
    ...
    },
    {
      ...
      stepCategory: 'landprep',
      variantLabel: 'Gravel',
      title: 'Land Prep — Gravel',
      icon: '🏗',
      timelineLabel: 'Weeks 2–4',
      action: 'Spread and level your gravel pad before delivery.',
      bullets: [
        { id: bulletId(), text: 'Your building will be installed on a gravel pad — surface must be level within 3" across the footprint.', locked: false },
        { id: bulletId(), text: 'Confirm any local county requirements for the foundation.', locked: false },
        { id: bulletId(), text: 'Ensure at least 14 feet of clearance for delivery trucks.', locked: false },
        { id: bulletId(), text: '{manufacturer} will be the installer for this building project.', locked: true },
        { id: bulletId(), text: 'Once your land is ready, email {successTeamEmail}.', locked: true },
